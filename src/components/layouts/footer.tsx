        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8 mb-16">
          <div className="lg:col-span-1">
            ...
            <p className="text-muted-foreground mb-6 max-w-sm">
              A premium digital marketing agency crafting luxury digital experiences and cutting-edge software solutions.
            </p>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              ...
              <li><Link href="#" className="text-muted-foreground hover:text-primary transition-colors inline-flex items-center group">AI Solutions <ArrowUpRight size={14} className="opacity-0 -translate-y-1 translate-x-1 group-hover:opacity-100 group-hover:translate-y-0 group-hover:translate-x-0 transition-all ml-1" /></Link></li>
